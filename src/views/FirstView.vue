...
const signin = () => {
    createUserWithEmailAndPassword(auth, S_email.value, S_password.value)
        .then((userCredential) => {
            ...
            signinData(user.uid)
            alert('create succeed ' + S_username);
            router.push('/');
            // ...
        })
        .catch((error) => {
...
<template>
        ...
        <div class="container h-100 m-0">
            <div class=" border-end h-100">
                <div class="ps-5 pt-3 pe-4 ">
                    ...
                    <div class="d-flex align-items-center mu mt-4 p-3">
                        <img src="https://cdn.icon-icons.com/icons2/1510/PNG/96/menuthincircularoutlinedbutton_104721.png" alt="add more"
                            width="40" height="40" />
                        <div class="ps-2 menu">
                            More
                        </div>
                        ...
                        <div class="col ">
                            ...
                            <div class="row pt-2">
                                <div class="col-1 d-flex justify-content-center">
                                    <a href=""> <img src="https://cdn.icon-icons.com/icons2/3523/PNG/96/user_interface_message_ui_chat_icon_221227.png" alt="add img"
                                            width="30" /></a>
                                </div>
                                <div class="col-1 d-flex justify-content-center">
                                    <a href=""><img src="https://cdn.icon-icons.com/icons2/3523/PNG/96/user_interface_favorites_like_heart_ui_love_icon_221231.png"
                                            alt="add emogi" width="30" /></a>
                                </div>
                                <div class="col"></div>
                                <div class="col-1 d-flex justify-content-center">
                                    <a href=""><img src="https://cdn.icon-icons.com/icons2/3523/PNG/96/user_interface_hand_gesture_like_ui_thumbsup_icon_221209.png"
                                            alt="add emogi" width="30" /></a>
                                </div>
                                <div class="col"></div>
                ...
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-6">
                        <div class="text-light">
                            <span style="font-size: 23px;">Never miss out on what's happening</span><br>
                            <span style="font-size: 15px;">and know before anyone else.</span>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <button class="btn btn-light" data-bs-target="#Signin" data-bs-toggle="modal">appy</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="Signin" aria-hidden="true" aria-labelledby="Signin" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="Signin">Subscribe</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
